...
impl atomic::Atomic {
    pub(crate) fn parse_atomic<V>(s: &str) -> error::Result<Self>
    where
        Parsed<V>: FromStr,
        V: Into<Self>,
    {
